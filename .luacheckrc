...
globals = {
	...
	"GetMouseFocus",
	"GetCursorPosition",
	"CompactRaidRaidGroupsFrame",
	"CompactRaidMainFrameContainerBorder",
	"CompactRaidToolboxGroupFilter",
	"CompactRaidGroupHeaderPet",
	"CLOSE",
	"CLASS",
	"MAINTANK",
	"MAIN_ASSIST",
	...
	"UnregisterStateDriver",
	"UnregisterStateDriver",
	"CompactRaidSoloFramePlayer",
	"CompactRaidPartyFramePet",
	"RegisterUnitWatch",
	"ceil",
	"UnitIsDead",
	"RAID_CLASS_COLORS",
